...
## شرط التمكين الكامل للوكيل
**القاعدة:** لا تُمنح القدرة الكاملة إلا بعد اكتمال الطبقات التي تمنع التوسع الخاطئ وتضمن الرجوع الآمن.  
**الطبقات المطلوبة قبل التمكين الكامل:**
1. قياس سببي مكتمل + ربط واضح لكل قرار بنتيجة (Attribution كامل).
2. قرار حتمي مقيّد بقواعد المجال مع تفسير قرار واضح للمستخدم.
3. فهم UI أعمق + تغطية سيناريوهات منهجية تسد الفجوات تلقائيًا.
4. تنقية معرفة فعّالة (حل تضارب المعرفة وترجيحها).
5. مسار نشر آمن للإنتاج (Canary/Rollback) قبل أي توسع واسع.
...
## ما سنفعله تاليًا
الترتيب التنفيذي من الآن:
1. توسيع القواعد الحتمية الحالية وربطها بقواعد المجال وتفسير القرار.
2. الانتقال إلى الفهم الأعمق للواجهة + تغطية السيناريوهات بشكل منهجي.
3. ثم نعود لإكمال بقية النقاط تدريجيًا حتى يصبح التمكين الكامل آمنًا.
