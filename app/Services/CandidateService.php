 ...
 * 
 * 🔄 الفرق بين CandidateService و MatchingService:
 * ------------------------------------------------
 * 
 * | الخاصية        | CandidateService           | MatchingService             |
 * |----------------|----------------------------|----------------------------|
 * | الوقت          | عند عرض صفحة القرار         | أثناء الاستيراد             |
 * | الهدف          | دقة أعلى + خيارات متعددة    | أسرع مطابقة ممكنة          |
 * | الخوارزمية     | safeLevenshteinRatio       | fastLevenshteinRatio       |
 * | النتيجة        | قائمة مرتبة من 5-10 مرشحين | مورد واحد (أو لا شيء)       |
 * 
 * @see MatchingService للمقارنة
 * 
 * PURPOSE:
 * --------
