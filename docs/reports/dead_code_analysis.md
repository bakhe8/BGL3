...
**التوصية**:
✅ **احذف `create_supplier.php`** - الملف الجديد أفضل وأكثر اكتمالاً

**الاستخدام**:

- `create-supplier.php` مستخدم من `records.controller.js:782`
- `create_supplier.php` غير مستخدم!
...
**التوصية**:
✅ **احذف `XlsxReader.php`** - غير مستخدمة، و`SimpleXlsxReader` كافية
...
### الخطوة 1: الحذف الآمن (فوراً)

```bash
# احذف الملفات المكررة
rm api/create_supplier.php
rm app/Support/XlsxReader.php
```
