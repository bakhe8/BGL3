# CRI-style Chat عبر Open WebUI + الأدوات المحلية  (بديل اختياري)

> المسار المعتمد داخل لوحة التحكم الآن هو **CopilotKit محلياً + tool_server.py + Ollama** (انظر قسم التشغيل الموحد في ملف CRI الرئيسي).  
> Open WebUI يبقى خياراً بديلاً فقط إذا أردت واجهة مستقلة خارج لوحة التحكم.
